...
### Light Mode
![Hero — Light](./screenshots/light-hero.png)
![Projects — Light](./screenshots/light-projects.png)
![Skills — Light](./screenshots/light-skills.png)
![Certifications — Light](./screenshots/light-certifications.png)

### Dark Mode
![Hero — Dark](./screenshots/dark-hero.png)
![Projects — Dark](./screenshots/dark-projects.png)
![Skills — Dark](./screenshots/dark-skills.png)
![Certifications — Dark](./screenshots/dark-certifications.png)
